...
const services = [
  ...
  { key: "managed-noc-service", name: "Managed NOC", icon: Server, desc: "Network Monitoring", image: "/images/command-center.jpg" },
  { key: "managed-cloud-service", name: "Cloud Services", icon: Cloud, desc: "Infrastructure & Migration", image: "/images/cloud-continuity.jpg" },
  { key: "managed-network", name: "IT Support", icon: Headset, desc: "Enterprise Help Desk", image: "/images/managed-operations.jpg" },
]
